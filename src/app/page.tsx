        ...
        <section id="picture" className={styles.pictureSection}>
          ...
          <div className={styles.imageContainer}>
            <p>
              ...
              do que ter a certeza de que ajudamos pessoas a retomarem suas
              vidas.
            </p>
            <Image
          ...
          <div className={styles.imageContainer}>
            <p>
              ...
              tem suas necessidades, por isso, cada trablho é único!
            </p>
            <Image
              className={styles.image}
        ...
        <section className={styles.feedbackSection}>
          ...
          <div id="cards" className={styles.cardsContainer}>
            <div>
              ...
              <p>
                5 ESTRELAS! exclente profisional, recomendo para todos meus
                amigos do buraco dos véi.
              </p>
            </div>
            <div>
              <h3>Leonardo Carvalho</h3>
              <p>
                5 ESTRELAS! sensacional, me pegou de jeito, fiquei cheio de
                ódio, boladão! mas recomendo.
              </p>
            </div>
            <div>
              <h3>Cauã de asis caleb leitao</h3>
              <p>
                5 ESTRELAS! uma rapariga é bom, 3 rapariga é bom demais, chama,
                chama TUH TUH TUH, arariariaoooo
              </p>
            </div>
          </div>
        </section>
